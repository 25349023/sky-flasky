...
class SeleniumTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            cls.client = webdriver.Firefox(executable_path=r'D:\firefox_driver\geckodriver',
                                           options=options)
        except:
            pass
    ...
    def test_admin_home_page(self):
        ...
        self.client.find_element_by_class_name('dropdown-toggle').click()
